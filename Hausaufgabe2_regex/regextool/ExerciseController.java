...
public class ExerciseController {
			...
			if (level == exercise.getLevel()) {
				...
				while(!exercise.isSucceded()) {
					...
					if(!exercise.isSucceded()) {
						System.out.println("(a) n�chste Aufgabe\n(t) Tipp\n(b) beenden und sichern\n( ) n�chster Versuch :)");
	...
	protected void displayFeedback(Exercise exercise) {
		System.out.println(
				"\nAlle W�rter sollten gr�n sein. Alles was nicht erkannt wird, wird rot dargestellt.");
		output(exercise.getGoodWords(), ANSI_GREEN, ANSI_RED);
		System.out.println("\nAlle W�rter sollten blau sein. Alles was erkannt wird, wird pink dargestellt.");
	...
	protected void displayExercise(Exercise exercise) {
		...
		System.out.println("Diese W�rter solltest du erkennen:");
		output(exercise.getGoodWords(), ANSI_GREEN, ANSI_GREEN);
		System.out.println("Diese W�rter solltest du nicht erkennen:");
	...
	public void printResult() {
		...
		System.out.println("Du hast das Level " + oldLevel + " absolviert. Herzlichen Gl�ckwunsch!\n\n");
		if(level != Exercise.END) {
			System.out.println("Du befindest dich nun im Level " + newLevel + ". M�ge die Macht mit dir sein ;)\n\n");
		}
		else {
