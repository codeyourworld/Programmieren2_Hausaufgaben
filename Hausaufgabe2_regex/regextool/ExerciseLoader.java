...
public class ExerciseLoader {
	...
	private static final String HINT_PLUS = "Mit [e]+ kann man sagen, dass man mindestens 1 e bis beliebig viele e haben m�chte.";
	...
	private static final String HINT_WORD = "Soll bestimmte Zeichen wie z.B. \"nie\" in einem Wort enthalten sein, schreibt man \"nie\" in den regu�ren Ausdruck.";
	...
	private static final String HINT_LETTERS_UL = "Mit [a-eA-F] kann man sagen, dass Kleinbuchstaben von a bis e und Gro�buchstaben von A bis F akteptiert sind. ";
	...
	private void loadExercises01() {
		...
		String text = "Filtert nach W�rtern, die ein \"auf\" enthalten. "
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises02() {
		...
		String text = "Filtert nach W�rtern, die Kleinbuchstaben enthalten. "
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
		Exercise exercise = new Exercise(Exercise.BEGINNER, text, goodWords, badWords);
	...
	private void loadExercises03() {
		...
		String text = "Filtert nach Ausdr�cken, die Zahlen enthalten. "
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
		Exercise exercise = new Exercise(Exercise.BEGINNER, text, goodWords, badWords);
	...
	private void loadExercises04() {
		...
		String text = "Filtert nach Ausdr�cken, die sowohl Klein- als auch Gro�buchstauben enthalten. "
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
		Exercise exercise = new Exercise(Exercise.BEGINNER, text, goodWords, badWords);
	...
	private void loadExercises11() {
		...
		String text = "Filtert nach Ausdr�cken, die ein Whitespace (Leertaste, Zeilenumbruch, Tab) enthalten. "
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises12() {
		...
		String text = "Filtert nach W�rtern, die nur aus Kleinbuchstaben von a - n bestehen. "
				+ "\nIn Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises13() {
		...
		String text = "Filtert nach Ausdr�cken, die mit 1-2 Zahlen bestehen, gefolgt von 1-2 Zahlen, gefolgt von 2-4 Zahlen."
				+ "\nIn Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises14() {
		...
		String text = "Filtert nach Ausdr�cken, die mit www. beginnen und mit .de aufh�ren. Dazwischen d�rfen nur Gro�- und Kleinbuchstaben sowie Zahlen stehen. "
				+ "\nIn Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises51() {
		...
		String text = "Filtert nach W�rtern, die mit s oder S beginnen, aber nicht mit s aufh�ren. "
				+ "Diese W�rter d�rfen nur aus Buchstaben bestehen und haben ab dem 2. Buchstaben nur kleine Buchstaben. "
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises52() {
		...
		String text = "Filtert nach Namen. Diese Namen d�rfen nur aus Buchstaben bestehen und k�nnen Leerzeichen enthalten. "
				+ "Ab dem 2. Buchstaben d�rfen nur kleine Buchstaben. Der erste Buchstabe darf kleingeschrieben sein. "
				+ "Es d�rfen keine zwei Leerzeichen aufeinander folgen. "
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises53() {
		...
		ArrayList<Word> badWords = new ArrayList<Word>();
		badWords.add(new Word("barfu� gehen"));
		...
		String text = "Filtert nach W�rtern, die mit a, A, B, b, c, C, d oder D beginnen und mit n aufh�ren. "
				+ "Diese W�rter d�rfen nur aus Buchstaben bestehen und haben ab dem 2. Buchstaben nur kleine Buchstaben."
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises54() {
		...
		String text = "Filtert nach W�rtern, die mit a oder A beginnen und ein n im Wort haben. "
				+ "Diese W�rter d�rfen nur aus Buchstaben bestehen und haben ab dem 2. Buchstaben nur kleine Buchstaben. "
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises55() {
		...
		goodWords.add(new Word("[23:59:59] 204 Punkte � was f�r eine grandiose Leistung."));
		...
		String text = "Stellt euch vor ihr h�ttet eine riesige Log-Datei eines Spiels. "
				...
				+ "g�ltige Uhrzeiten stehen k�nnen. In so einer Zeile k�nnen Zahlen, Buchstaben, "
				+ "Leerzeichen, Doppelpunkte, Satzzeichen auftreten. " + "Ihr sollt die komplette Zeile filtern."
				+ "In Gr�n sind die Zeilen aufgef�hrt, die ihr filtern solltet. In Rot sind Zeilen aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises56() {
		...
		goodWords.add(new Word("hierk�nntedeine@email.sein"));
		...
		String text = "Schreibt eine Methode boolean emailCheck(String email), dabei sollt ihr pr�fen, "
				...
				+ "danach m�ssen 2-4 Buchstaben wieder folgen. Eure emailCheck()-Methode soll pr�fen, "
				+ "ob angegebene Email-Adressen diesem Schema folgen. "
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. "
				+ "In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises57() {
		...
		String text = "Filtert nach Ausdr�cken, die mit 1-2 Zahlen bestehen, gefolgt von 1-2 Zahlen, gefolgt von 2 oder 4 Zahlen."
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. "
				+ "In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises61() {
		...
		String text = "Filtert nach Ausdr�cken, die ein richtiges Datum enthalten. Das Jahr soll dabei 4-stellig sein"
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. "
				+ "In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
	...
	private void loadExercises62() {
		...
		String text = "Filtert, ob der Ausdruck ein g�ltiger Identifier(Bezeichner/Variablenname) ist. G�ltig ist der Name, wenn er mit einem Buchstaben, $ oder _ beginnt. Die folgenden Zeichen k�nnen Buchstaben, Zahlen, _ und $ sein."
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. "
				+ "In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
		Exercise exercise = new Exercise(Exercise.CHUCK_NORRIS, text, goodWords, badWords);
		exercise.addHints(HINT_SPECIAL);		
	...
	private void loadExercises63() {
		...
		String text = "Erweitert eure Aufgabe und pr�ft, ob eine boolean Variable richtig deklariert wurde. Zwischen dem Datentyp und dem Variablennamen etc. muss mindestens ein Whitespace. Damit darf auch ein Zeilenumbruch stehen."
				+ "In Gr�n sind die W�rter aufgef�hrt, die ihr filtern solltet. "
				+ "In Rot sind W�rter aufgef�hrt, die ihr nicht filtern solltet.";
		Exercise exercise = new Exercise(Exercise.CHUCK_NORRIS, text, goodWords, badWords);
		exercise.addHints(HINT_SPECIAL);		
